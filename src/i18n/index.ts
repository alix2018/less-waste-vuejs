...
import { translations, defaultLanguage, availableLanguages } from './translations';
...
const determineDefaultLanguage = () => {
  ...
  if (websiteAvailableLanguages.includes(savedLanguage)) {
    ...
    userLanguages.every((userLanguage) => {
      // Determine the highest language supported. Ex: en-nl will select English language
