...
const messages = {
  ...
  fr: {
    home: {
      ...
      about_us_description: 'Bonjour à toi qui est assis bien sagement derrière ton écran. Nous sommes Shannon & Stéphanie, respectivement Belge et Française vivant en Belgique et aux Pays-Bas. Oui, ça fait un sacré mix.\n\nTu te demandes surement pourquoi on a fait ce site ? Figure toi qu\'on travaille toutes les 2 à la réduction de nos déchets et on a vite eux les mêmes frustrations et les mêmes expériences foireuses, promis on te racontera !\n\nDu coup on aimerait t\'embarquer dans notre aventure et t\'aider à développer la tienne (que tu en sois à tes débuts ou que tu aies déjà de l\'expérience). Ce qu\'on veut c\'est rendre ton expérience la plus sympa possible en te fournissant les infos dont tu as besoin facilement.  Et puis pourquoi pas embarquer tes potes aussi car tout seul on n\'irait pas très loin pour sauver notre belle planète. 🌍',
