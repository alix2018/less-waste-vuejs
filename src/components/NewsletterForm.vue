          ...
          <form id="sib-form" method="POST" action="https://3cf400b4.sibforms.com/serve/MUIEAD1g6kLimFaRptXe3hq5EUXQbXxypoIL-zygjWzg17ngee6xnzUTRpoA99V8LlXtOgcLUq2cUCfhtLERRJvGWJZCtU7aMP9Pi5d8P0Lkzp-WuyC4_1-wMav755fvyzyb4D2opIKwGU3_nahFB_mAr_ALVS36TZCbtNjQXRTZUaKDqEoai7_KqMPcDIbye9MWXI1F_tn-C2Ev" data-type="subscription">
            <div style="padding: 8px 0;">
              <div class="sib-form-block flex" style="font-size:32px; text-align:left; font-weight:700; color:#272D2D; background-color:transparent;">
                <p>Newsletter</p>
                <img src="../assets/cross.svg" height="18" @click="onClickCloseModal">
              </div>
            </div>
            <div style="padding: 8px 0;">
                  ...
                  <div class="form__label-row ">
                    <div class="entry__choice">
                      <label>
                        ...
                        <span class="checkbox checkbox_tick_positive"></span><span style="font-size:14px; text-align:left; color:#272D2D; background-color:transparent;"><p>I agree to receive your newsletters and accept the data privacy statement.</p></span> </label>
                    </div>
                  </div>
                  <label class="entry__error entry__error--primary" style="font-size:16px; text-align:left; color:#661d1d; background-color:#ffeded; border-radius: 6px; border-color:#ff4949;">
                  </label>
            ...
            <div style="padding: 8px 0;">
              <div class="sib-form-block" style="text-align: left">
                <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-size:16px; text-align:left; font-weight:700; color:#FFFFFF; background-color:#3E4857; border-radius: 6px; border-width:0px;" form="sib-form" type="submit" :disabled="disableSubmitButton" @click="onClickSubmitButton">
