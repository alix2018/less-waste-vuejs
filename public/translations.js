...
const translations = {
  en: {
    ...
    home: {
      ...
      about_us_description: "Hallo aan jij die rustig voor uw scherm zit. We are <span class=\"highlight\">Shannon & Stéphanie</span>, respectievelijk Belg en Fransman die in België en Nederland wonen. Ja, het is nogal een mix.\n\nJe vraagt je waarschijnlijk af waarom we deze website gemaakt hebben? We werken allebei aan het <span class=\"highlight\">verminderen van onze verspilling</span> en onderweg kregen we al snel dezelfde frustraties en dezelfde klote ervaringen... We gaan het zeker met jij delen! Daarom willen wij je graag meenemen op <span class=\"highlight\">ons zero waste avontuur</span> en je helpen het uwe te ontwikkelen (of u nu al enige ervaring hebt of niet). Wat wij willen is je ervaring zo aangenaam mogelijk maken door de informatie die je nodig hebt <span class=\"highlight\">gemakkelijk</span> te verstrekken. En waarom neemt u jouw vrienden niet mee? Want alleen zouden we niet ver komen om onze mooie planeet te redden. 🌍",
      ...
      share_description: "Send them the URL of this website. Don't forget your family, your colleagues, your neighbour, your cat, your dog... So we can all act at our own level!",
      language_en: "English",
      language_fr: "French",
      language_nl: "Dutch",
  ...
  fr: {
    ...
    home: {
      ...
      share_description: "Envoie-leur l'URL de ce site web, et n'oublie pas ta famille, tes collègues, ton voisin, ton chat, ton chien... Pour qu'on puisse tous agir à notre échelle&#8239;!",
      language_en: "Anglais",
